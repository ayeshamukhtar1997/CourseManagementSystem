 ...
 * @author LENOVO
 */
public class Majo extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jPanel1.add(jLabel1);
        jLabel1.setBounds(260, 0, 180, 40);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MajorFF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
